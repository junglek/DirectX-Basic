...
HRESULT init3D(HWND hWnd){
	...
	g_pDevice->SetRenderState(D3DRS_SRCBLEND, D3DBLEND_SRCALPHA);	//Alpha[src]
	g_pDevice->SetRenderState(D3DRS_DESTBLEND, D3DBLEND_INVSRCALPHA);//1-Alpha[src]
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT){
	...
	HWND hWnd = CreateWindow( L"ClassName", L"Alpha Blend", 
