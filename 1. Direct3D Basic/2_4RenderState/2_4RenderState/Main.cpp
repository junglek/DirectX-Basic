...
bool											g_bFlat = false;
int											g_iFillmode = 3;	//1point 2wire 3face
...
VOID render(){
	...
	else g_pDevice->SetRenderState(D3DRS_SHADEMODE, D3DSHADE_GOURAUD);
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT){
	...
	HWND hWnd = CreateWindow(L"ClassName", L"Render State Demo",
